import DirectionList from '../../../content/mouse_gesture/direcrion/direcrion_list';
import { Direction } from '../../../content/mouse_gesture/direcrion/direction';
...
export default class GestureSettings {
    private static readonly default: GestureSetting[] = [
        new GestureSetting(GestureType.ScrollUp, new DirectionList([Direction.Up])),
        new GestureSetting(GestureType.ScrollDown, new DirectionList([Direction.Down])),
        new GestureSetting(GestureType.BackToPrevious, new DirectionList([Direction.Left])),
        new GestureSetting(GestureType.GoToNext, new DirectionList([Direction.Right])),
        new GestureSetting(GestureType.ScrollTop, new DirectionList([Direction.Down, Direction.Up])),
        new GestureSetting(GestureType.ScrollBottom, new DirectionList([Direction.Up, Direction.Down])),
        new GestureSetting(GestureType.SelectRightTab, new DirectionList([Direction.Up, Direction.Right])),
        new GestureSetting(GestureType.SelectLeftTab, new DirectionList([Direction.Up, Direction.Right])),
        new GestureSetting(GestureType.CloseAndSelectRightTab, new DirectionList([Direction.Down, Direction.Right])),
        new GestureSetting(GestureType.CloseAndSelectLeftTab, new DirectionList([Direction.Down, Direction.Right])),
    ];
